...
namespace TutorialApplications.Data_Connection
{
    public class TutorialDBConnection
    {
        string sqlConnectionStr = "Data Source=PRATHYUSHAAMBAT\\SQLEXPRESS;Initial Catalog=TutorialDB;Integrated Security=True";
